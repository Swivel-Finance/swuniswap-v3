...
NUM_TICKS = int(os.getenv("NUM_TICKS", 3))  # The number of liquidity ticks to split your amount into (Per side + 1 at market price)
COMPOUND_RATE_LEAN = float(os.getenv("COMPOUND_RATE_LEAN", 1))  # How much your quote should change when Compound’s rate varies (e.g. 1 = 1:1 change in price)
EXPIRY_LENGTH = float(os.getenv("EXPIRY_LENGTH", 600))  # How often orders should be refreshed (in seconds)
